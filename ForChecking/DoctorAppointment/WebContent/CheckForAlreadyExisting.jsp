...
String query = "select a.slot,a.couponno,a.pid,p.pname,d.Id,d.dname from doctor d,Appointment a,patient p where d.ID=a.ID AND a.pid=p.pid AND a.date_of_app=?";
